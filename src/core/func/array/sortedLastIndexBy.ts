...
/**
 * This method is similar to _.sortedLastIndex, except that it takes a predicate, which is called for the value and
 * each element of the array to calculate their sort rank. Predict is called with a single argument value: T.
 *
 * @static
 * @memberOf _
 * @since 1.0.0
